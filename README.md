...
ep[شماره قسمت]_[موضوع کوتاه به انگلیسی].py
...
| ۲ | اولین ربات ساده | `ep02_first_bot.py` |
| ۳ | دریافت و ارسال پیام | `ep03_send_recv_msg.py` |
| ۴ | کیبوردهای شیشه‌ای و دکمه‌دار | `ep04_keyboards.py` |
| ۵ | ارسال رسانه (عکس، فایل، صدا) | `ep05_send_media.py` |
